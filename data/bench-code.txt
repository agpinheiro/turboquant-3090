...
rem  MTP custa ~1.8 GB fixos de VRAM. set NMAX=0 desliga (preciso acima de 327680).
if "%NMAX%"=="" set "NMAX=2"
...
rem  Com KV=q2_1 o padrao sobe para 262144, o contexto de treino do modelo.
rem  Acima disso ver a secao do YaRN abaixo.
...
rem  YaRN: obrigatorio acima de 262144, o contexto de treino. Sem RoPE scaling
rem  configurado o servidor capa o slot em 262144 (server-context.cpp:1211) e voce
rem  paga o KV do que pediu para usar 262k. Mesma logica do run-longo.ps1.
rem  Nao e padrao porque a Qwen avisa que YaRN estatico piora textos curtos.
rem  Acima de 262144 o KV precisa ser q2_1: com q4_0 nem 400k carrega (24562 MiB).
set "YARN="
if !CTX! GTR 262144 set "YARN=--rope-scaling yarn --rope-scale 4 --yarn-orig-ctx 262144"

rem  MTP e ~1.8 GB fixos, nao proporcionais ao contexto. Com q2_1 o teto medido e
rem  327680 (978 MiB livres, 50.4 t/s); em 400k sobram ~55 MiB e o WDDM comeca a
rem  paginar VRAM para a RAM - a maquina trava sem escrever erro no log. Medido em
rem  450k: carrega com 530 MiB livres e trava durante a geracao.
...
set "YARNMSG=off"
if not "!YARN!"=="" set "YARNMSG=on, orig-ctx 262144, scale 4"
set "MTPMSG=n=%NMAX%"
if "%NMAX%"=="0" set "MTPMSG=off"
echo   ctx    : !CTX!   KV !KV!   MTP !MTPMSG!   YaRN !YARNMSG!
